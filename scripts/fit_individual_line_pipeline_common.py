#!/usr/bin/env python3
"""Shared helpers for the individual-line saved-spectrum fitting pipeline."""
...
DEFAULT_SNAP = 99
DEFAULT_RUN_LABEL = "L2Rvir"
DEFAULT_BASE_DIR = "/scratch/tsingh65/m61-tng/outputs"
DEFAULT_OUTPUT_SUBDIR = "fitted_individual_line_spectra_snr10_bin3"
DEFAULT_SID_FILE = str(REPO_ROOT / "data" / "sids_from_cutouts_snap99.txt")
DEFAULT_TASK_LIST = str(REPO_ROOT / "batch" / "fit_individual_line_spectra_tasks_snap99_L2Rvir.tsv")
