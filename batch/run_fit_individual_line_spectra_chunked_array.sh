...
#SBATCH --output=/home/tsingh65/m61-tng/logs/fit_individual_line_spectra/chunk_%A_%a.out
#SBATCH --error=/home/tsingh65/m61-tng/logs/fit_individual_line_spectra/chunk_%A_%a.err
...
TASKS_PER_JOB="${TASKS_PER_JOB:-20}"
...
#   N_TASKS=$(($(wc -l < /home/tsingh65/m61-tng/batch/fit_individual_line_spectra_tasks_snap99_L2Rvir.tsv) - 1))
#   TASKS_PER_JOB=20
#   N_JOBS=$(((N_TASKS + TASKS_PER_JOB - 1) / TASKS_PER_JOB))
#   sbatch --array=1-2%2 /home/tsingh65/m61-tng/batch/run_fit_individual_line_spectra_chunked_array.sh
#   sbatch --array=1-${N_JOBS}%50 /home/tsingh65/m61-tng/batch/run_fit_individual_line_spectra_chunked_array.sh
#
